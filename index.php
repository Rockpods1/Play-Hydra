...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Unblocked games for the students of QHE"
    />
    <meta
      name="keywords"
      content="playhydra, unblocked games, unblocked, unblocked playhydra"
    />
  ...
  <body>
    <p
      ...
      "
    >
      <a href="/posts/2022/ukraine.html" style="color: #161515;"
        >An important PSA</a
      >
    </p>
    <div class="nav-container">
      <a href="index.html"
        ><img
          src="assets/images/playhydra.png"
          alt="PLAYHYDRA LOGO"
          title="PLAYHYDRA"
          class="logo"
      /></a>
    ...
    <div id="search-items">
      ...
      <div class="search-item">
        <img
          src="assets/images/retrobowl.jfif"
          alt="Retrobowl"
          class="search-img"
        />
      ...
      <div class="search-item">
        <img
          src="assets/images/fnaf 3.jpg"
          alt="Five Nights at Freddy's 3"
          class="search-img"
        />
        <a
          href="game.html?title=Five Nights at Freddy's 3&url=https://scratch.mit.edu/projects/393471387/embed&height=600&width=1400"
      ...
      <div class="search-item">
        <img
          src="assets/images/tunnel rush.jpg"
          alt="Tunnel Rush"
          class="search-img"
        />
      ...
      <div class="search-item">
        <img
          src="assets/images/worlds hardest game.jpg"
      ...
      <div class="search-item">
        <img
          src="assets/images/drift hunters.jpg"
          alt="Drift Hunters"
          class="search-img"
        />
      ...
      <div class="search-item">
        <img
          src="assets/images/cookie clicker.jpg"
          alt="Cookie Clicker"
          class="search-img"
        />
      ...
      <div class="search-item">
        <img
          src="assets/images/madalin stunt cars.jpg"
          alt="Madalin Stunt Cars 2"
          class="search-img"
        />
      ...
      <div class="search-item">
        <img
          src="assets/images/modern blocky paint.jpg"
          alt="Modern Blocky Paint"
          class="search-img"
        />
      ...
      <div class="search-item">
        <img
          src="assets/images/idle breakout.jpg"
          alt="Idle Breakout"
          class="search-img"
        />
      ...
      <div class="search-item">
        <img
          src="assets/images/dino game.jpg"
      ...
      <div class="search-item">
        <img
          src="assets/images/tanuki sunset.jpg"
          alt="Tanuki Sunset"
          class="search-img"
        />
        <a
          href="game.html?title=Tanuki Sunset&url=https://tanuki-sunset.vakhtangi1980.repl.co/&width=1400&height=680"
          >Tanuki Sunset</a
        >
      </div>
      <div class="search-item">
        <img
          src="assets/images/bloons td 4.jpg"
          alt="Bloons Tower Defense 4"
          class="search-img"
        />
        <a
          href="game.html?title=Bloons%20Tower%20Defense%204&width=600&height=600&url=https://scratch.mit.edu/projects/62965100/embed"
          >Bloons Tower Defense 4</a
        >
      </div>
      <div class="search-item">
        <img
          src="assets/images/radius-raid.jpg"
          alt="Radius Raid"
          class="search-img"
        />
        <a href="games/radius-raid/index.html">Radius Raid</a>
      </div>
      <div class="search-item">
        <img
          src="assets/images/street fighter.jpg"
          alt="Street Fighter"
          class="search-img"
        />
        <a href="games/street-fighter/index.html">Street Fighter</a>
      </div>
      <div class="search-item">
        <img
      ...
      <div class="search-item">
        <img
          src="assets/images/csgo-clicker.jpg"
          alt="CSGO Clicker"
          class="search-img"
        />
        <a href="games/csgo-clicker/index.html">CSGO Clicker</a>
      </div>
    </div>
    <!-- hey there, code digger -->
    <!-- https://l8nxpl.csb.app/assets/css/thing.txt -->
